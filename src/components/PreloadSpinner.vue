<template>
  <div class="pagepreloader overlay">
    <!-- v-if="toggleFlag" v-on:click="toggleFlag" v-bind:class="{ active: flag }" v-on:click="" v-if="flag"-->
